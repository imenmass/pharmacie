...
class UpdatePharmacien extends StatefulWidget {
  ...
  late String _cin ;
  late String _email ;
   UpdatePharmacien({required id,required nom,required prenom,required ntel,required cin,required email,  Key? key}) :

  _id = id , _nom = nom , _prenom = prenom , _ntel = ntel ,_cin = cin , _email = email, super(key: key);
              ...
              Center(
                child: ElevatedButton(
                  onPressed: () {
                    ...
                    PharmacienServices().UpdatePharmacien(widget._id, nom, prenom, cin, email, ntel)
                        .then((value) =>
                    {
                        Navigator.of(context)
                        .pushReplacement(new MaterialPageRoute<Pharmacien>(
